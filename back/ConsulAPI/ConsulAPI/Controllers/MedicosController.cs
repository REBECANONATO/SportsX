...
namespace ConsulAPI.Controllers
{
    public class MedicosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Crm,Nome,Telefone,Valor")] Medico medico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Crm,Nome,Telefone,Valor")] Medico medico)
        {
            if (id != medico.Id)
            {
                return NotFound();
